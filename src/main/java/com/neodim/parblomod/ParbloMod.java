...
import com.neodim.parblomod.client.ModItems;
...
@Mod(ParbloMod.MOD_ID)
@Mod.EventBusSubscriber(bus = Mod.EventBusSubscriber.Bus.MOD)
public class ParbloMod
{

    public static final String MOD_ID = "parblomod";
    ...
    public static void registerItems(RegistryEvent.Register<Item> e) {
        ...
        registry.registerAll(parbloShieldItem);
    }
